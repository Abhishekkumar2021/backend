...
class CacheService:
    ...
    def get_schema(self, connection_id: int) -> Optional[Dict[str, Any]]:
        """
    ...
    def get_config(self, connection_id: int) -> Optional[Dict[str, Any]]:
        """
    ...
    def get_test_result(self, connection_id: int) -> Optional[Dict[str, Any]]:
    ...
    def clear_all(self) -> bool:
        ...
        try:
            ...
            for prefix in [self.PREFIX_SCHEMA, self.PREFIX_CONFIG, 
                          self.PREFIX_TEST, self.PREFIX_METADATA]:
                pattern = f"{prefix}*"
